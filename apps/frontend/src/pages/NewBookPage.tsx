...
export const NewBookPage: React.FC = () => {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			setMessage({ text: '✅ Libro creado/copias actualizadas con éxito.', type: 'success' });
	...
	return (
		<div className="p-8 max-w-lg mx-auto bg-white shadow-xl rounded-lg">
			<h2 className="text-3xl font-bold text-gray-800 mb-6 border-b pb-2">📘 Crear/Actualizar Libro</h2>
			...
			<form onSubmit={handleSubmit} className="space-y-6">
				...
				<div>
					...
					<input type="number" name="copies" id="copies" value={formData.copies} onChange={handleChange} required min="1" className="w-full px-4 py-2 border border-gray-300 rounded-lg" disabled={isLoading} />
				</div>
